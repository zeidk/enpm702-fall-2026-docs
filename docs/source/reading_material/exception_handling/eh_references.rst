...
.. dropdown:: Exception Handling
    ...
    .. card::
        ...
        **Exception Handling**
        ...
        Covers C++ exception handling with ``try``, ``catch``, and
        ``throw``. Standard exception hierarchy, custom exception
        classes, ``noexcept``, exception safety guarantees, and RAII
