...
.. dropdown:: Flow Control and Operations
    ...
    .. card::
        ...
        **Flow Control and Operations**
        ...
        Covers selection statements (``if``, ``switch``), iteration
        statements (``while``, ``do-while``, ``for``), operator
        precedence, arithmetic operators, relational operators, and
        logical operators.
