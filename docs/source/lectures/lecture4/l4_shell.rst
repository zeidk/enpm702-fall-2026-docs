...
Eight exercises that build on the shell skills from Lectures 1 to 3 and
add tools for text processing, file comparison, archiving and shell
scripting: ``xargs``, ``tee``, ``diff`` and ``comm``, ``tar`` and
``zip``, here-documents, and arrays and loops. Exercise 8 is a
**challenge** that combines them into one script.

.. note::

   **Working through them.** Open a terminal (``Ctrl + Alt + T``) and
   run every command yourself. Each exercise opens with the tool and an
   example, then lists the tasks. Keep the commands you used and their
   output; that is what you hand in.


----


.. dropdown:: Exercise 1 (shell): xargs
    :icon: gear
...
.. dropdown:: Exercise 3 (shell): diff and comm
    :icon: gear
    :class-container: sd-border-primary
    :class-title: sd-font-weight-bold
...
.. dropdown:: Exercise 4 (shell): tar and zip
    :icon: gear
    :class-container: sd-border-primary
    :class-title: sd-font-weight-bold
...
.. dropdown:: Exercise 5 (shell): Here Documents (Heredoc)
    :icon: gear
    :class-container: sd-border-primary
    :class-title: sd-font-weight-bold
...
.. dropdown:: Exercise 6 (shell): Shell Arrays and Loops
    :icon: gear
    :class-container: sd-border-primary
    :class-title: sd-font-weight-bold
...
.. dropdown:: Exercise 7 (shell): Combining Tools
    :icon: gear
    :class-container: sd-border-primary
    :class-title: sd-font-weight-bold
...
.. dropdown:: Exercise 8 (challenge): C++ Project Scaffold
    :icon: gear
    :class-container: sd-border-primary
    :class-title: sd-font-weight-bold
